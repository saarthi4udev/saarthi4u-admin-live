              ...
              {data.map((transactionData: any, index: any) => (
                <tr key={index}>
                  <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                    ...
                    <p className="text-sm">{transactionData.email}</p>
                  </td>
                                      ...
                                      <div className="row1">
                                        <div className="allData col-md-9 col-lg-9">
                                          ...
                                          <div>
                                            ...
                                            {selectedTransactionData.quantity}
                                          </div>
                                          <div>
                                            <strong>Session ID:</strong>{' '}
                                            {selectedTransactionData.session_id.substring(
                                              0,
                                              20,
                                            )}
                                            ...
                                          ...
                                          <div>
                                            ...
                                            {
                                              selectedTransactionData.total_price
                                            }
                                          </div>
                                          <div>
                                            <strong>Type:</strong>{' '}
                                            {selectedTransactionData.type}
                                          </div>
                                          <div>
                                            <strong>Date:</strong>{' '}
                                            {new Date(
                                              selectedTransactionData.updatedAt,
                                            ).toLocaleString()}
                                          </div>
                                        </div>
                                      </div>
