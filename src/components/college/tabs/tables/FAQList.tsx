...
export default function FAQList({ faqs, handleDelete }: any) {
    const [search, setSearch] = useState("");

    const filteredFAQs = faqs.filter((c: any) =>
                    ...
                    <table className="w-full table-auto">
                        <thead>
                            <tr className="bg-gray-2 dark:bg-meta-4 text-left">
                                ...
                                <th className="py-3 px-4 font-medium text-black dark:text-white">Question</th>
                                <th className="py-3 px-4 font-medium text-black dark:text-white">Answer</th>
                        ...
                        <tbody>
                            {filteredFAQs.map((faq: any, index: number) => (
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4 text-black dark:text-white">{faq.question || "No Data"}</td>
                                    <td className="py-3 px-4 text-black dark:text-white">{faq.answer || "No Data"}</td>
