...
export default function FacilityList({ facilitys, handleDelete }: any) {
    const [search, setSearch] = useState("");

    const filteredFacilities = facilitys.filter((c: any) =>
                    ...
                    <table className="w-full table-auto">
                        <thead>
                            <tr className="bg-gray-2 dark:bg-meta-4 text-left">
                                ...
                                <th className="py-3 px-4 font-medium text-black dark:text-white">Description</th>
                        ...
                        <tbody>
                            {filteredFacilities.map((facility: any, index: number) => (
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4 text-black dark:text-white">{facility.name || "No Data"}</td>
                                    <td className="py-3 px-4 text-black dark:text-white">{facility.description || "No Data"}</td>
