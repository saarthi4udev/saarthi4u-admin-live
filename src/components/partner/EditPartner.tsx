...
import { getEducationalPartnerById, updateEducationalPartner } from "../../api/api";
const EditPartner: React.FC = () => {
    ...
    useEffect(() => {
        const fetchPartner = async () => {
            try {
                const res = await getEducationalPartnerById(id);
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            await updateEducationalPartner(id, formData);
        ...
        <div className="col-span-12 px-5 pt-7.5 pb-5 shadow-default">
            ...
            <div className="add-adminForm">
                ...
                <textarea
                    ...
                    maxLength={200}
                    rows={3}
                    placeholder='e.g., "Trusted for exam preparation with 10+ years of experience"'
                    onChange={handleChange}
                    className="add-adminInput"
                ></textarea>
                <p className="text-xs text-gray-400 -mt-2 mb-2">{data.description.length}/200</p>
