...
import OnlineConsultantsTable from '../components/OnlineConsultantsTable';

const OnlineConsultationLayout = () => {
        ...
        <div className="admin-main-content relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
          ...
          <main>
            <div className="mx-auto w-full max-w-screen-2xl p-3 sm:p-4 md:p-6 2xl:p-8">
              <Breadcrumb pageName="Online Consultation Data" />
              <OnlineConsultantsTable />
            </div>
          </main>
          {/* <!-- ===== Main Content End ===== --> */}
        </div>
...
export default OnlineConsultationLayout;
